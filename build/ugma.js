 ...
 * 
 * Build date: Mon, 16 Mar 2015 13:40:25 GMT
 */
(function() {
    ...
    function Element(node) {
        ...
        if (this instanceof Element) {
            ...
            return node["__trackira__"] || new Element(node);
        } else {
            return new Node();
        }
    }
    ...
    var util$vendorPrefixed$$vendorPrefixed = toolset$$map(VENDOR_PREFIXES.concat(null), function(p) {
    ...
    var util$selectormatcher$$disconMatch = !!HTML[util$vendorPrefixed$$vendorPrefixed].call(DOCUMENT.createElement("div"), "div"),
        util$selectormatcher$$rquickIs = /^(\w*)(?:#([\w\-]+))?(?:\[([\w\-\=]+)\])?(?:\.([\w\-]+))?$/;

    var util$selectormatcher$$default = function(selector, context) {
        if (!toolset$$is(selector, "string")) return null;
        ...
        return function(node) {var $D$0;var $D$1;
            var result, found;
            /* istanbul ignore if */
            if (!quick && !util$vendorPrefixed$$vendorPrefixed) {
            ...
            for (; node && node.nodeType === 1; node = node.parentNode) {
                if (quick) {
                    ...
                    if (util$vendorPrefixed$$vendorPrefixed && util$selectormatcher$$disconMatch) {
                        // use try/catch in case someone try a unexpected
                        // and non-supported selector (e.g. ':hello');
                        try {
                            result = node[util$vendorPrefixed$$vendorPrefixed](selector);
                        } catch (e) {
                            // Use a nice error message rather then a ugla throw :)
                            minErr$$minErr("matches()", "Not a supported selector.");
                        }
                    } else {
    ...
    toolset$$implement({
        ...
        var doc = this[0].ownerDocument,
            sandbox = this._["__sandbox_trackira__"];
    
        if (!sandbox) {
            sandbox = doc.createElement("div");
            this._["__sandbox_trackira__"] = sandbox;
        }
    ...
    function util$eventhooks$$DebouncedWrapper(handler, node) {
        ...
        return function(e)  {
            if (!debouncing) {
                debouncing = true;
                node._["__raf_trackira__"] = ugma.requestFrame(function() {
                    handler(e);
                    debouncing = false;
                });
            }
        ...
        var node = el[0],
            ...
            handler = function(e)  {
                ...
                if (props) {
                    ...
                    args = toolset$$slice.call(e["__trackira__"] || [0], 1);
                }
    ...
    toolset$$implement({
        ...
        injectCSS: function(selector, cssText) {
            var styleSheet = this._["__styles_trackira__"];
            ...
            if (!styleSheet) {
                ...
                this._["__styles_trackira__"] = styleSheet;
            }
    ...
    var util$pseudoselectors$$rfocusable = /^(?:input|select|textarea|button)$/i,
        util$pseudoselectors$$pseudos = {
    
            ":input": function(node)  {return util$pseudoselectors$$rfocusable.test(node.nodeName)},
            ...
            ":enabled": function(node)  {return node.disabled === false},
            ":disabled": function(node)  {return node.disabled === true},
            // In CSS3, :checked should return both checked and selected elements
            // http://www.w3.org/TR/2011/REC-css3-selectors-20110929/#checked
    
            ":checked": function(node)  {return (node.nodeName === "INPUT" && !!node.checked) || (node.nodeName === "OPTION" && !!node.selected)},
    
            ":focus": function(node)  {return node === node.ownerDocument.activeElement},
    
            ":visible": function(node)  {return !util$pseudoselectors$$pseudos[":hidden"](node)},
    
            ":hidden": function(node)  {return node.style.visibility === "hidden" || node.style.display === "none"}  
    
        };

    function util$pseudoselectors$$createButtonPseudo(type) {
    ...
    function util$pseudoselectors$$createInputPseudo(type) {
        return function(node)  {
            var name = node.nodeName.toLowerCase();
    ...
    toolset$$forOwn({ radio: true, checkbox: true, file: true, text: true, password: true, image: true }, function(key, value)  {
        util$pseudoselectors$$pseudos[":" + key] = util$pseudoselectors$$createInputPseudo(key);
    });

    toolset$$forOwn({ submit: true, reset: true }, function(key, value)  {
        util$pseudoselectors$$pseudos[":" + key] = util$pseudoselectors$$createButtonPseudo(key);
    });

    var util$pseudoselectors$$default = util$pseudoselectors$$pseudos;
    ...
    toolset$$implement({
        ...
        matches: function(selector) {
            ...
            if (selector && toolset$$is(selector, "string")) {
                ...
                var checker = util$pseudoselectors$$default[selector] ||
                    // native
    ...
    toolset$$implement({
        mock: function(content, varMap) {
            ...
            var result = this.create(content, varMap),
                mappings = this._["__mutations_trackira__"],
    ...
    if (INTERNET_EXPLORER < 10) {
        ...
        modules$mutate$$cssText = WEBKIT_PREFIX + "animation-name:__ugma_trackira__ !important;";
    ...
    toolset$$implement({
        ...
        mutate: function(selector, condition, definition) {var this$0 = this;
            ...
            var node = this[0],
                mutations = this._["__mutations_trackira__"];
    
            if (!mutations) {
                this._["__mutations_trackira__"] = mutations = [];
                ...
                if (INTERNET_EXPLORER < 10) {
                    ...
                    this.injectCSS("@" + WEBKIT_PREFIX + "keyframes __ugma_trackira__", "from {opacity:.99} to {opacity:1}");
                    // use capturing to suppress internal animationstart events
                    node.addEventListener(WEBKIT_PREFIX ? "webkitAnimationStart" : "animationstart", function(e)  {
                        if (e.animationName === "__ugma_trackira__") {
                            toolset$$each(mutations, function(ext)  {
                                ext(e.target);
                            });
            ...
            var ctr = definition.hasOwnProperty("setup") && definition.setup,
                ...
                ext = function(node, mock)  {
                    var el = Element(node),
                        invoked = el._["__invoked_trackira__"];
    
                    if (!invoked) el._["__invoked_trackira__"] = invoked = [];
        ...
        off: function(type, selector, callback) {
            ...
            var self = this,
                ...
                removeHandler = function(handler)  {
                    ...
                    if (self._["__raf_trackira__"]) {
                        ugma.cancelFrame(self._["__raf_trackira__"]);
                        // Zero out rAF id used during the animation
                        self._["__raf_trackira__"] = null;
                    }
                    // Remove the listener
                    node.removeEventListener((handler._type || handler.type), handler, !!handler.capturing);
                };
    
            this._["__handler_trackira__"] = toolset$$filter(this._["__handler_trackira__"], function(handler)  {
    ...
    toolset$$implement({
        ...
        var
            listeners = this._["__handler_trackira__"];
    
        if (!listeners) {
            this._["__handler_trackira__"] = listeners = [];
    ...
    toolset$$implement({
        ...
        set: function(name, value) {var this$0 = this;
            ...
            var hook = util$accessorhooks$$default.set[name],
                subscription = (this._["__subscription_trackira__"] || {})[name],
                oldValue;
    ...
    if (INTERNET_EXPLORER) {
        ...
        modules$shadow$$MUTATION_WRAPPER = modules$shadow$$MUTATION_WRAPPER.replace("position:absolute", "width:calc(100% + 4px);height:calc(100% + 4px);left:-2px;top:-2px;position:absolute");
    
            // for IE>8 have to set the data attribute AFTER adding element to the DOM
            modules$shadow$$MUTATION_WRAPPER = modules$shadow$$MUTATION_WRAPPER.replace("data=`about:blank` ", "");
    }
    ...
    toolset$$implement({
        shadow: function(name) {var callback = arguments[1];if(callback === void 0)callback = function()  {};
            var contexts = this._["__context_trackira__"] || (this._["__context_trackira__"] = {}),
                data = contexts[name] || [];
            ...
            var ctx = ugma.create(modules$shadow$$MUTATION_WRAPPER),
    ...
    // Subscribe on particular properties / attributes, and get notified if they are changing
        subscribe: function(name, callback) {
            var subscription = this._["__subscription_trackira__"];
    
            if (!subscription) this._["__subscription_trackira__"] = subscription = [];
    ...
    toolset$$implement({
        ...
        if (!node.ownerDocument.documentElement.contains(node)) {
            ...
            this._["__frame_trackira__"] = ugma.requestFrame(!animationHandler ? done : function()  {

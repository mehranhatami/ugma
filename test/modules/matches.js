describe("matches", function() {
    ...
    it("should work on disconnected nodes - #1", function() {
        expect(ugma.create("div").matches("div")).toBe(true);
    });
    
    it("should work on disconnected nodes - #2", function() {
        // unselected option
        expect(link.append(ugma.create("option").set("value", "fooBar")).matches(":selected")).toBe(false);
    ...
    it("should work with objects", function() {
        expect(ugma.query("#is1").matches( ugma.query("li"))).toBe(true);
    });
